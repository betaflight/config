...
#define TIMER_PIN_MAPPING \
    ...
    TIMER_PIN_MAP( 8, LED_STRIP_PIN, 1,  2) \
    TIMER_PIN_MAP( 9, UART2_RX_PIN,  3, -1) \
    TIMER_PIN_MAP(10, UART2_TX_PIN,  3, -1) \
    TIMER_PIN_MAP(11, UART4_RX_PIN,  2,  0) \
    TIMER_PIN_MAP(12, UART4_TX_PIN,  2,  0)

#define ADC1_DMA_OPT 1

#define DEFAULT_MIXER    MIXER_Y6
