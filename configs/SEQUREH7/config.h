...
#define TIMER_PIN_MAPPING \
    TIMER_PIN_MAP(  0, BEEPER_PIN, 1, 5 ) \
    ...
    TIMER_PIN_MAP(  6, FLASH_CS_PIN, 1, 0 ) \
    TIMER_PIN_MAP(  7, PINIO1_PIN, 1, 0 ) \
    TIMER_PIN_MAP(  8, MOTOR5_PIN, 2, 0 ) \
    TIMER_PIN_MAP(  9, MOTOR6_PIN, 2, 0 ) \
    TIMER_PIN_MAP( 10, UART4_RX_PIN, 2, 0 ) \
    TIMER_PIN_MAP( 11, UART4_TX_PIN, 2, 0 )
