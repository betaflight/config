...
#define BOARD_NAME        BROTHERHOBBYF435
...
#define TIMER_PIN_MAPPING \
 	...
 	TIMER_PIN_MAP(2, PB10, 1, 13) \
 	TIMER_PIN_MAP(3, PB11, 1, 12) \
 	TIMER_PIN_MAP(4, PB7, 1, 4) \
 	TIMER_PIN_MAP(5, PB6, 1, 2) \
 	TIMER_PIN_MAP(6, PB0, 2, 9) \
 	TIMER_PIN_MAP(7, PB1, 2, 8) \
