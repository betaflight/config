...
#define BOARD_NAME        TERAVOLTAEROF4
#define MANUFACTURER_ID   TVLT

#define TARGET_BOARD_IDENTIFIER "TAF4"
#define USBD_PRODUCT_STRING      "AeroF4"
#define USBD_MANUFACTURER_STRING "TeraVolt"
