...
#define TIMER_PIN_MAPPING \
    ...
    TIMER_PIN_MAP( 1, PE11, 1,  0) /* TIM1_CH2 */ \
    TIMER_PIN_MAP( 2, PE13, 1,  0) /* TIM1_CH3 */ \
    TIMER_PIN_MAP( 3, PE14, 1,  0) /* TIM1_CH4 */ \
    TIMER_PIN_MAP( 4, PD12, 1,  0) /* TIM4_CH1 */ \
    TIMER_PIN_MAP( 5, PD13, 1,  0) /* TIM4_CH2 */ \
    TIMER_PIN_MAP( 6, PD14, 1,  0) /* TIM4_CH3 */ \
    TIMER_PIN_MAP( 7, PD15, 1,  0) /* TIM4_CH4 NO DMA */ \
