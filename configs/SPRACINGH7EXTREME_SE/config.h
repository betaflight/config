...
// Identical to the SPRacingH7EXTREME except it uses an H743 and a Micron MT29F1G01ABAFDWB-IT:F flash chip
#define FC_TARGET_MCU     STM32H743

#define BOARD_NAME        SPRACINGH7EXTREME_SE
#define MANUFACTURER_ID   SPRO

#define TARGET_BOARD_IDENTIFIER "SP7S"
#define USBD_PRODUCT_STRING "SPRacingH7EXTREME-SE"
